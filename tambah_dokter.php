...
<body>
	...
	<div class="horizontal-menu">
		...
		<form action="save_dokter.php" method="post">
			...
			<input type="text" name="id_dokter" class="form_login" placeholder="Identitas Dokter.." required="required">
			...
			<input type="text" name="id_poli" class="form_login" placeholder="1 Poli Umum 2 Poli Gigi .." required="required">
